...
uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Generics.Collections, System.UITypes, System.Variants, System.Classes, System.Devices, Vcl.Graphics,
...
type
  ...
  private
    ...
    procedure PyCriticalError(Sender: TObject; E: Exception);
  public
    { Public declarations }
  end;
...
{$R *.dfm}
procedure TForm2.PyCriticalError(Sender: TObject; E: Exception);
begin
  if E is EPyException then
  begin
...
function canExecute(delayMs: Cardinal):Boolean;
begin
...
begin
  ...
  Application.OnException := PyCriticalError;
  ...
  else Button2.Caption := 'Not found';
